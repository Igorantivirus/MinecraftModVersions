...
//std::string getCurentVersion(const std::string minePath)
//{
//	std::ifstream in{ minePath + CURENTVERSION_FILE};
//	std::string version;
//	std::getline(in, version);
//	in.close();
//	return version;
...
//std::string getNeedVersion()
//{
//	std::cout << L"Введите версию, на которую нужно изменить моды: "_utf8;
//	std::string res;
//	std::getline(std::cin, res);
//	return res;
//}

//void setNeedVersion(const std::string minePath, const std::string& version)
//{
//	std::ofstream out{ minePath + CURENTVERSION_FILE };
//	out << version;
//	out.close();
//}

//void copyAll(const std::string& from, const std::string& to)
//{
//	fs::path sourceDir = from;
//	fs::path targetDir = to;
//
...
//		catch (fs::filesystem_error& e)
//		{
//			std::cerr << "Error copying " << path << " to " << targetPath << ": " << e.what() << '\n';
//		}
//	}
//}

//bool isMineVersion(const std::string& version, const std::string& minePath)
//{
//	return fs::exists(minePath + VERSION_PATH + version);
//}
...
//int updateMods()
//{
//	const std::string minePath = getMinecraftPath();
//	const std::string need = getNeedVersion();
//
//	if (!isMineVersion(need, minePath))
//	{
//		std::cout << L"Такой версии не существует."_utf8 << std::endl;
//		return 1;
//	}
//
//	if (need == getCurentVersion(minePath))
//	{
//		std::cout << L"Вы хотите перейти на уже используемую версию."_utf8 << std::endl;
//		return 2;
//	}
//
//	fs::remove_all(minePath + "mods\\");
//
//	copyAll(minePath + MINEVERSIONS_PATH + need + "\\" + MODS_PATH, minePath + MODS_PATH);
//	copyAll(minePath + MINEVERSIONS_PATH + need + "\\" + CONFIGS_PATH, minePath + CONFIGS_PATH);
//
//	setNeedVersion(minePath, need);
//
//	std::cout << L"Моды обновлены."_utf8 << std::endl;
//	return 0;
//}
//
//int printVersion()
//{
//	const std::string minePath = getMinecraftPath();
//	std::cout << L"Текущая версия модов: "_utf8 << getCurentVersion(minePath) << std::endl;
//	return 0;
//}
//
//
...
//	if (argc != 2)
//	{
//		std::cout << L"Введена пустая команда"_utf8 << std::endl;
//		return 0;
//	}
//	
//	if (isEqual(argv[1], "help"))
//	{
//		std::cout << L"mineVersion -\tвывести текущую версию модов"_utf8 << std::endl;
//		std::cout << L"update -\tизменить текущую версию модов"_utf8 << std::endl;
//		return 0;
//	}
//
